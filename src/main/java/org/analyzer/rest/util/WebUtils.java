package org.analyzer.rest.util;
...
public class WebUtils {
    ...
    public File createTempFile(@NonNull final MultipartFile multipartFile) {
        try {
            ...
            final var fileName = multipartFile.getOriginalFilename() == null ? multipartFile.getName() : multipartFile.getOriginalFilename();
            final var result = destDirPath.resolve(fileName);
