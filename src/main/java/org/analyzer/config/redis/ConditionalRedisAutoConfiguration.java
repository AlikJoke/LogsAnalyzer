package org.analyzer.config.redis;
...
public class ConditionalRedisAutoConfiguration {
    ...
    private ObjectMapper createObjectMapper() {
        ...
        StdTypeResolverBuilder typeResolverBuilder = new ObjectMapper.DefaultTypeResolverBuilder(ObjectMapper.DefaultTyping.EVERYTHING, mapper.getPolymorphicTypeValidator());
